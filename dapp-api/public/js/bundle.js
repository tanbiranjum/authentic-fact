...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Users\\tanbi\\Documents\\CODE\\tanbiranjum\\dapp",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
const login = async (email, password) => {
  try {
    ...
    if (res.data.status === 'success') {
      alert('Logged in successfully'); //when logged in, load the home page after 1 and a half seconds
...
const loginForm = document.querySelector('.form--login'); //const signupForm = document.querySelector('.form--signup')
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10950" + '/');
